...
CREATE TABLE USER_COMMENTS (
  ...
  CONSTRAINT user_fk3 FOREIGN KEY (id_user) REFERENCES USERS(uuid) ON DELETE CASCADE,
  CONSTRAINT video_fk2 FOREIGN KEY (id_video) REFERENCES VIDEOS(id) ON DELETE CASCADE,
  PRIMARY KEY (id)
);
